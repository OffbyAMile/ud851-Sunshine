...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETE Add a TextView variable for the error message display
    private TextView mErrorTextView;

    // COMPLETE Add a ProgressBar variable to show and hide the progress bar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETE Find the TextView for the error message using findViewById
        mErrorTextView = (TextView) findViewById(R.id.tv_error_message);

        // TODO (17) Find the ProgressBar using findViewById
        mProgressBar = (ProgressBar) findViewById(R.id.error_progress_bar);
