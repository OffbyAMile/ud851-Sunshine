...
//  DONE (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mDateHighTemp;
    private TextView mDateLowTemp;
    private TextView mDateHumidity;
    private TextView mDateWind;
    private TextView mDatePressure;
...
//      DONE (13) Find each of the TextViews by ID
        mDateView = (TextView) findViewById(R.id.mTextView_selectedDay_date);
        mDateDescription = (TextView) findViewById(R.id.mSelected_day_weather);
        mDateHighTemp = (TextView) findViewById(R.id.mSelected_day_high_temp);
        mDateLowTemp = (TextView) findViewById(R.id.mSelected_day_low_temp);
        mDateHumidity = (TextView) findViewById(R.id.mSelected_day_humidity);
        mDatePressure = (TextView) findViewById(R.id.mSelected_day_pressure);
        mDateWind = (TextView) findViewById(R.id.mSelected_day_wind);
    ...
    public Loader<Cursor> onCreateLoader(int loaderId, Bundle loaderArgs) {
        ...
        switch (loaderId) {
            case ID_DETAIL_LOADER:
                ...
                default:
                    throw new RuntimeException("Loader was not Implemented:" + loaderId);
        }
    }
...
//    (27) Display the weather description (using SunshineWeatherUtils)
        ...
        mDateDescription.setText(description);
//    (28) Display the high temperature
        double highInCelsius = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = SunshineWeatherUtils.formatTemperature(this, highInCelsius);
        // Set the text for high temp
        mDateHighTemp.setText(highString);
//    (29) Display the low temperature
        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);
        // Set text for low temp
        mDateLowTemp.setText(lowString);
//    (30) Display the humidity
        float humidity = data.getFloat(INDEX_WEATHER_HUMIDITY);
        String humidityString = getString(R.string.format_humidity, humidity);
        // Set the text for humidity
        mDateHumidity.setText(humidityString);
//    (31) Display the wind speed and direction
        float windSpeed = data.getFloat(INDEX_WEATHER_WIND_SPEED);
        float windDirection = data.getFloat(INDEX_WEATHER_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
        // Set the text for wind speed and direction
        mDateWind.setText(windString);
//    (32) Display the pressure
        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String pressureString = getString(R.string.format_pressure, pressure);
        // Set text for pressure
        mDatePressure.setText(pressureString);
