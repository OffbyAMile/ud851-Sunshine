...
//       (7) Replace the single TextView with Views to display all of the weather info
        // Weather Icon views
        int weatherId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
        weatherImageId = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        // Set Adapter for text and Accessibility features
        ...
        // Set high temperature programmatically
        ...
        // Set low temperature programmatically
